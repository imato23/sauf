...
export class VintageInfoService {
  ...
  public getNextAvailableStorageLocation(): Observable<StorageLocation> {
    return this.httpClient.get<StorageLocation>(`${this.vintageInfoApiUrl}/storage-locations/next-available`);
  }
